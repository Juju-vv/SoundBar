...
while True:
    try:
        ...
        to_fill_RAnim = int(min(num_leds / 2 * peakR * multiplier, num_leds/2))    # how many LEDs are we going to fill up for the left channel (second animation)


        if to_fill_LAnim < int(0.4 * num_leds / 2) or to_fill_RAnim < int(0.4 * num_leds / 2): #LED strip will display this animation if less than 40% of the leds have to be turned on
            ...
            else:   #If more than 40% of the LEDs have to be turned on, display the second animation
